# IslandSim Game Design

This document describes the world, rules, and scenario used by IslandSim. For project setup and development information, see [README.md](README.md).
